                        ...
                        <div class="p-5">
                            ...
                            <form class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user" id="ulangi_password" placeholder="Ulangi Password">
                                    </div>
                                </div>
                                <a href="<?php echo base_url(); ?>/auth" class="btn btn-info btn-user btn-block">
                                    Daftar Akun
                                </a>
                            </form>
                            <hr>
